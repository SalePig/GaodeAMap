package com.pateo.qiuzhiwen.gaodelocation.amap;
...
import com.pateo.qiuzhiwen.gaodelocation.amap.util.SensorEventHelper;
...
//        DisplayMetrics dm = resources.getDisplayMetrics();
    ...
    private void init() {
        ...
        MAPVIEW.onCreate(((Activity)getContext()).getIntent().getExtras());
...
//        mSensorHelper.setCurrentMarker(mLocMarker);//定位图标旋转
    ...
    private int getImageId(String fileName) {
        int drawableId = ((Activity)getContext()).getResources().getIdentifier(fileName, "drawable", CONTEXT.getClass().getPackage().getName());
        if (drawableId == 0) {
            drawableId = ((Activity)getContext()).getResources().getIdentifier("splash", "drawable", CONTEXT.getPackageName());
        }
    ...
    protected Parcelable onSaveInstanceState() {
        if (((Activity)getContext()).getIntent() != null && ((Activity)getContext()).getIntent().getExtras() != null) {
            MAPVIEW.onSaveInstanceState(((Activity)getContext()).getIntent().getExtras());
        }
